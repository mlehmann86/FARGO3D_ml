...
//masterprint("USES ALPHA VISCOSITY\n");
...
#endif
#ifdef VISCOSITY
	sdiff_yczc[ll] = nuxy; //X
	sdiff_yfzc[ll] = nuxy; //Y
//masterprint("USES CONSTANT VISCOSITY\n");
#ifdef Z
	sdiff_yczf[ll] = nuxy; //Z
#ifdef DUSTVG
#ifdef EQUILIBRIUM
	sdiff_yczf[ll] = nuz; //Z
#endif
#endif
	sdiff_yfzf[ll] = nuz; //NOT USED
#endif
#endif
//<\#>
#ifdef X
